...
return new class extends Migration
{
    public function up(): void
    {
        ...
        Schema::create('customer_cart_items', function (Blueprint $table) {
            $table->id();
            $table->foreignId('cart_id')->constrained('customer_carts')->cascadeOnDelete();
    ...
    {
        foreach (['customer_notifications', 'customer_preferences', 'customer_wishlists', 'customer_cart_items', 'customer_carts', 'customer_order_items', 'customer_orders', 'customer_addresses'] as $table) {
