...
{
    public function __construct(private readonly StaffRepositoryInterface $staff, private readonly AuditLogRepositoryInterface $audit) {}
    ...
    public function execute(object $target, StaffData $data, object $actor): object
    {
        ...
        $this->audit->record($actor, 'staff.updated', get_class($actor), $target->id, ['roles' => $data->rolesProvided ? $data->roleSlugs : null, 'status' => $data->status]);
