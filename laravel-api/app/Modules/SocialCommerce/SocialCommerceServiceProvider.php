...
{
    public array $bindings = [SocialConnectionRepositoryInterface::class => EloquentSocialConnectionRepository::class, SocialInteractionRepositoryInterface::class => EloquentSocialInteractionRepository::class, SocialMessagingProviderInterface::class => SocialMessagingProviderRouter::class, SocialSummaryQueryInterface::class => EloquentSocialSummaryQuery::class, AutomationRuleRepositoryInterface::class => EloquentAutomationRuleRepository::class, MessageTemplateRepositoryInterface::class => EloquentMessageTemplateRepository::class];
