...
final class ManageProductReviews
{
    ...
    public function approved(int $productId): iterable
    {
    ...
    public function submit(int $userId, int $productId, array $data): object
    {
        return $this->reviews->createForVerifiedCustomer($userId, $productId, $data);
    }
