...
final class EloquentShippingMethodRepository implements ShippingMethodRepositoryInterface
{
    ...
    {
        return ShippingMethod::query()->where('is_active', true)->orderBy('name')->get();
    }

    public function listAll(): iterable
    {
        return ShippingMethod::query()->latest()->get();
    }
    ...
    public function find(int $id): object
    {
        ...
        if ($method === null) {
            throw new ShippingRateNotFoundException('Shipping method not found.');
        }
