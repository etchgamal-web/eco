...
final class MonitoringServiceProvider extends ServiceProvider { public array $bindings=[MonitoringRepositoryInterface::class=>EloquentMonitoringRepository::class]; }
