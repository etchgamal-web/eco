...
final class GetOperationalAlerts { public function __construct(private readonly MonitoringRepositoryInterface $repo){} public function execute(array $filters):array{return $this->repo->alerts($filters);} }
final class GetOperationalAlert { public function __construct(private readonly MonitoringRepositoryInterface $repo){} public function execute(int $id):mixed{return $this->repo->alert($id);} }
